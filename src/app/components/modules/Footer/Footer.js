...
export default function Footer() {
    return (
        <div className=' relative snap-center'>
            ...
            <div className=" flex justify-center items-center flex-col gap-16 p-20 text-black bg-[url('/images/jpg/footer-bg.jpg')] bg-cover bg-center bg-no-repeat z-50">
                ...
                <div className=" flex flex-col text-center">
                    ...
                    <span className=' text-zinc-600 hover:text-zinc-800 cursor-pointer transition-colors'>خیابان دانزمیر، لس آنجلس، کالیفرنیا 90036، ایالات متحده آمریکا</span>
                    <span className=' text-zinc-600 hover:text-zinc-800 cursor-pointer transition-colors'>خیابان آتکینز، بروکلین، نیویورک 11208، ایالات متحده</span>
                </div>
                <div className=" flex flex-col text-center  ">
