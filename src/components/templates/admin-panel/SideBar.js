...
// Icons
import { IoBasket, IoHome, IoLogOut, IoNotifications, IoSearch, IoTicket } from "react-icons/io5";
import { FaUsers } from "react-icons/fa";
import { HiOutlineBars3BottomRight } from "react-icons/hi2";
import { LiaTimesSolid } from "react-icons/lia";
import { BiSolidContact, BiSolidDiscount } from "react-icons/bi";
        ...
        <>
            ...
            <div className={` fixed ${openSideBar ? '-right-0' : '-right-96'} xl:-right-0  top-0 bottom-0 bg-white shadow-2xl xl:shadow-none xl:relative xl:flex justify-center flex-col gap-10 p-5 xl:p-0 z-50 h-full w-72 transition-all duration-300 `}>
                ...
                <div className="flex justify-start items-center gap-5 flex-col w-full h-full">
                    <SideBarLink route={'/p-admin'} text='پیشخوان'>
                        <IoHome className='text-xl' />
                    </SideBarLink>
                    <SideBarLink route={'/p-admin/products'} text='محصولات'>
                        <IoBasket className='text-xl' />
                    </SideBarLink>
                    <SideBarLink route={'/p-admin/users'} text='کاربران'>
                        <FaUsers className='text-xl' />
                    </SideBarLink>
                    <SideBarLink route={'/p-admin/contacts'} text='ارتباط با ما'>
                        <BiSolidContact   className='text-xl' />
                    </SideBarLink>
                    <SideBarLink route={'/p-admin/comments'} text='کامنت ها'>
                        <IoIosChatboxes className='text-xl' />
                    </SideBarLink>
                    <SideBarLink route={'/p-admin/tickets'} text='تیکت ها'>
                        <IoTicket className='text-xl' />
                    </SideBarLink>
                    <SideBarLink route={'/p-admin/discounts'} text='تخفیفات'>
