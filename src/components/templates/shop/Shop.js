...
export default function ShopPage({ products }) {
    ...
    const [status, setStatus] = useState("expensive")
    ...
    return (
        <div className=' container mx-auto p-10 mb-28'>
            ...
            <div className='flex justify-center items-start gap-5 w-full '>
                <div className={`lg:relative fixed top-0 bottom-0 lg:-left-0 ${isOpenSideBar ? "  left-0 " : " -left-96"} w-72 bg-white shadow-lg lg:shadow-none shadow-secondary border-r-1 lg:border-none border-primary p-10 lg:p-0 z-50  flex justify-start items-center flex-col gap-5 lg:w-1/3 transition-all`}>
